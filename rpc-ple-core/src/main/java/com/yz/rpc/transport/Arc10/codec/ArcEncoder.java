 ...
 */
@Slf4j
public class ArcEncoder extends MessageToByteEncoder<Message> {
...
//    private static volatile JamesEncoder INSTANCE = null;
    ...
    public ArcEncoder(Serializer serializer){
        this.serializer = serializer;
    }

    //双重检测锁实现单例的延迟加载
//    public static ArcEncoder getInstance(Serializer serializer){
//        if(INSTANCE==null){
