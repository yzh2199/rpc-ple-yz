...
import com.yz.rpc.autoconfig.beanPostProcessor.RPCConsumerBeanPostProcessor;
import com.yz.rpc.autoconfig.beanPostProcessor.RPCProviderBeanPostProcessor;
...
import com.yz.rpc.cluster.loadBalance.LeastActiveLoadBalancer;
import com.yz.rpc.common.ExtensionLoader;
import com.yz.rpc.common.enumeration.*;
...
import com.yz.rpc.client.filter.impl.ActivityStatisticsFilter;
import com.yz.rpc.protocol.api.support.AbstractProtocol;
import com.yz.rpc.proxy.api.RPCProxyFactory;
import com.yz.rpc.registry.api.ServiceRegistry;
import com.yz.rpc.registry.zookeeper.ZKServiceRegistry;
...
/**
 * springboot自动配置类
 * rpc-ple-springboot-starter作为第三方依赖配置到项目中时,该类可以自动配置所有bean并注册到spring容器中供应用程序使用
 *
 * @author yz
 * create at 2020/4/4
 */
